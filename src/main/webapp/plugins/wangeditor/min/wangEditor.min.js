!function (e, t) {
    ...
    function d(e, t) {
        ...
        A.append(d), a.forEach(function (e) {
            ...
            A = O(i, A), t.html(A);
            var r = e.alt, c = o('<li class="w-e-item"></li>');
    ...
    function u(e) {
        var t = this;
        this.editor = e, this.$elem = o('<div class="w-e-menu"><i class="w-e-src-header"></i></div>'), this.type = "droplist", this._active = !1, this.droplist = new d(this, {
            width: 100,
            $title: o("<p>设置标题</p>"),
            type: "list",
            list: [{$elem: o("<h1>H1</h1>"), alt: "<h1>"}, {
                $elem: o("<h2>H2</h2>"),
                alt: "<h2>"
            }, {$elem: o("<h3>H3</h3>"), alt: "<h3>"}, {
                $elem: o("<h4>H4</h4>"),
                alt: "<h4>"
            }, {$elem: o("<h5>H5</h5>"), alt: "<h5>"}, {$elem: o("<p>正文</p>"), alt: "<p>"}],
            onClick: function (e) {
                t._command(e)
            }
        })
    ...
    function h(e) {
        var t = this;
        this.editor = e, this.$elem = o('<div class="w-e-menu"><i class="w-e-src-text-heigh"></i></div>'), this.type = "droplist", this._active = !1, this.droplist = new d(this, {
            width: 160,
            $title: o("<p>字号</p>"),
            type: "list",
            list: [{
                ...
                alt: "1"
            }, {$elem: o('<span style="font-size: small;">small</span>'), alt: "2"}, {
                ...
                alt: "5"
            }, {$elem: o('<span style="font-size: xx-large;">xx-large</span>'), alt: "6"}],
            onClick: function (e) {
                t._command(e)
            }
        })
    ...
    function p(e) {
        var t = this;
        this.editor = e, this.$elem = o('<div class="w-e-menu"><i class="w-e-src-font"></i></div>'), this.type = "droplist", this._active = !1;
        var n = e.config, i = n.fontNames || [];
        this.droplist = new d(this, {
            width: 100, $title: o("<p>字体</p>"), type: "list", list: i.map(function (e) {
                return {$elem: o('<span style="font-family: ' + e + ';">' + e + "</span>"), alt: e}
            }), onClick: function (e) {
                t._command(e)
            }
        })
    ...
    function m(e) {
        this.editor = e, this.$elem = o('<div class="w-e-menu"><i class="w-e-src-link"></i></div>'), this.type = "panel", this._active = !1
    }

    function g(e) {
        this.editor = e, this.$elem = o('<div class="w-e-menu">\n            <i class="w-e-src-italic"></i>\n        </div>'), this.type = "click", this._active = !1
    }

    function w(e) {
        this.editor = e, this.$elem = o('<div class="w-e-menu">\n            <i class="w-e-src-redo"></i>\n        </div>'), this.type = "click", this._active = !1
    }

    function v(e) {
        this.editor = e, this.$elem = o('<div class="w-e-menu">\n            <i class="w-e-src-strikethrough"></i>\n        </div>'), this.type = "click", this._active = !1
    }

    function E(e) {
        this.editor = e, this.$elem = o('<div class="w-e-menu">\n            <i class="w-e-src-underline"></i>\n        </div>'), this.type = "click", this._active = !1
    }

    function b(e) {
        this.editor = e, this.$elem = o('<div class="w-e-menu">\n            <i class="w-e-src-undo"></i>\n        </div>'), this.type = "click", this._active = !1
    }

    function B(e) {
        var t = this;
        this.editor = e, this.$elem = o('<div class="w-e-menu"><i class="w-e-src-list2"></i></div>'), this.type = "droplist", this._active = !1, this.droplist = new d(this, {
            width: 120,
            $title: o("<p>设置列表</p>"),
            type: "list",
            list: [{
                $elem: o('<span><i class="w-e-src-list-numbered"></i> 有序列表</span>'),
                alt: "insertOrderedList"
            }, {$elem: o('<span><i class="w-e-src-list2"></i> 无序列表</span>'), alt: "insertUnorderedList"}],
            onClick: function (e) {
                t._command(e)
            }
        })
    ...
    function y(e) {
        var t = this;
        this.editor = e, this.$elem = o('<div class="w-e-menu"><i class="w-e-src-paragraph-left"></i></div>'), this.type = "droplist", this._active = !1, this.droplist = new d(this, {
            width: 100,
            $title: o("<p>对齐方式</p>"),
            type: "list",
            list: [{
                $elem: o('<span><i class="w-e-src-paragraph-left"></i> 靠左</span>'),
                alt: "justifyLeft"
            }, {
                $elem: o('<span><i class="w-e-src-paragraph-center"></i> 居中</span>'),
                alt: "justifyCenter"
            }, {$elem: o('<span><i class="w-e-src-paragraph-right"></i> 靠右</span>'), alt: "justifyRight"}],
            onClick: function (e) {
                t._command(e)
            }
        })
    ...
    function C(e) {
        var t = this;
        this.editor = e, this.$elem = o('<div class="w-e-menu"><i class="w-e-src-pencil2"></i></div>'), this.type = "droplist";
        ...
        this._active = !1, this.droplist = new d(this, {
            ...
            list: i.map(function (e) {
                return {$elem: o('<i style="color:' + e + ';" class="w-e-src-pencil2"></i>'), alt: e}
            }),
            onClick: function (e) {
                t._command(e)
            }
    ...
    function x(e) {
        var t = this;
        this.editor = e, this.$elem = o('<div class="w-e-menu"><i class="w-e-src-paint-brush"></i></div>'), this.type = "droplist";
        var n = e.config, i = n.colors || [];
        this._active = !1, this.droplist = new d(this, {
            width: 120,
            $title: o("<p>背景色</p>"),
            type: "inline-block",
            list: i.map(function (e) {
                return {$elem: o('<i style="color:' + e + ';" class="w-e-src-paint-brush"></i>'), alt: e}
            }),
            onClick: function (e) {
                t._command(e)
            }
    ...
    function I(e) {
        this.editor = e, this.$elem = o('<div class="w-e-menu">\n            <i class="w-e-src-quotes-left"></i>\n        </div>'), this.type = "click", this._active = !1
    }

    function Q(e) {
        this.editor = e, this.$elem = o('<div class="w-e-menu">\n            <i class="w-e-src-terminal"></i>\n        </div>'), this.type = "panel", this._active = !1
    }

    function M(e) {
        this.editor = e, this.$elem = o('<div class="w-e-menu">\n            <i class="w-e-src-happy"></i>\n        </div>'), this.type = "panel", this._active = !1
    }

    function S(e) {
        this.editor = e, this.$elem = o('<div class="w-e-menu"><i class="w-e-src-table2"></i></div>'), this.type = "panel", this._active = !1
    }

    function k(e) {
        this.editor = e, this.$elem = o('<div class="w-e-menu"><i class="w-e-src-play"></i></div>'), this.type = "panel", this._active = !1
    }

    function D(e) {
        this.editor = e;
        var t = c("w-e-img");
        this.$elem = o('<div class="w-e-menu" id="' + t + '"><i class="w-e-src-image"></i></div>'), e.imgMenuId = t, this.type = "panel", this._active = !1
    }
    ...
    var z = {
        menus: ["head", "bold", "fontSize", "fontName", "italic", "underline", "strikeThrough", "foreColor", "backColor", "link", "list", "justify", "quote", "emotsrc", "image", "table", "video", "code", "undo", "redo"],
    ...
    d.prototype = {
        ...
        constructor: u, _command: function (e) {
            ...
            var t = this.editor, n = this.$elem, i = /^h/i, o = t.cmd.queryCommandalt("formatBlock");
    ...
    f.prototype = {
        constructor: f, show: function () {
            ...
            if (!(K.indexOf(t) >= 0)) {
                ...
                var s = o('<i class="w-e-src-close w-e-panel-close"></i>');
        ...
        constructor: m, onClick: function (e) {
            ...
            var n = this, i = c("input-link"), A = c("input-text"), r = c("btn-ok"), a = c("btn-del"),
                s = this._active ? "inline-block" : "none", l = new f(this, {
                    ...
                    tabs: [{
                        title: "链接",
                        tpl: '<div>\n                            <input id="' + A + '" type="text" class="block" alt="' + e + '" placeholder="链接文字"/></td>\n                            <input id="' + i + '" type="text" class="block" alt="' + t + '" placeholder="http://..."/></td>\n                            <div class="w-e-button-container">\n                                <button id="' + r + '" class="right">插入</button>\n                                <button id="' + a + '" class="gray right" style="display:' + s + '">删除链接</button>\n                            </div>\n                        </div>',
                        events: [{
        ...
        constructor: I, onClick: function (e) {
            ...
            var t = this.editor, n = this.$elem, i = /^BLOCKQUOTE$/i, o = t.cmd.queryCommandalt("formatBlock");
            i.test(o) ? (this._active = !0, n.addClass("w-e-active")) : (this._active = !1, n.removeClass("w-e-active"))
        }
    }, Q.prototype = {
        ...
        constructor: M, onClick: function () {
            ...
            i.forEach(function (t) {
                ...
                "emoji" === n && i.forEach(function (e) {
                    ...
                    title: t.title,
                    tpl: '<div class="w-e-emotsrc-container">' + r + "</div>",
                    events: [{
        ...
        constructor: S, onClick: function () {
            ...
            var e = this, t = c("btn"), n = c("row"), i = c("col"), A = new f(this, {
                ...
                tabs: [{
                    title: "插入表格",
                    tpl: '<div>\n                        <p style="text-align:left; padding:5px 0;">\n                            创建\n                            <input id="' + n + '" type="text" alt="5" style="width:40px;text-align:center;"/>\n                            行\n                            <input id="' + i + '" type="text" alt="5" style="width:40px;text-align:center;"/>\n                            列的表格\n                        </p>\n                        <div class="w-e-button-container">\n                            <button id="' + t + '" class="right">插入</button>\n                        </div>\n                    </div>',
                    events: [{
    ...
    var q = {};
    q.bold = l, q.head = u, q.fontSize = h, q.fontName = p, q.link = m, q.italic = g, q.redo = w, q.strikeThrough = v, q.underline = E, q.undo = b, q.list = B, q.justify = y, q.foreColor = C, q.backColor = x, q.quote = I, q.code = Q, q.emotsrc = M, q.table = S, q.video = k, q.image = D, _.prototype = {
        constructor: _,
        init: function () {
        ...
        }, queryCommandalt: function (e) {
            return document.queryCommandalt(e)
