function imgVer(Config) {
    ...
    var left_Num = -X + 10;
    var html = '<div class="none" style="position:relative;padding:16px 16px 28px;border:1px solid #ddd;background:#f2ece1;border-radius:16px;">';
    ...
    html += '</div>';
    html += '<br>';
    html += '<div class="fou" style="position:relative;width:' + w + 'px;margin:auto;">';
